...
# -*- coding: utf-8 -*-
"""
Property-Based Test: Tests for mobile robots using the Property-Based Language Generator in user defined scenarios
...
class TestScenario(Base):
    ...
    def test_scenario_execution(self, randomizer, rtdl_config): 
        ...
        try:
            odom_frame = rtdl_config[2][0].scenario_modifier[0].sm_robot_frames[0].odom_frame
            base_link_frame = rtdl_config[2][0].scenario_modifier[0].sm_robot_frames[0].base_link_frame
        except:
            odom_frame= 'odom'
        ...
        try:
            ...
            coord_x = rtdl_config[2][0].scenario_modifier[0].sm_robot_goal[0].x_pos
            coord_y = rtdl_config[2][0].scenario_modifier[0].sm_robot_goal[0].y_pos
            direction = rtdl_config[2][0].scenario_modifier[0].sm_robot_goal[0].y_ori
        except:
        ...
        try:
            # Direct control test
            if rtdl_config[2][0].scenario_modifier[0].sm_robot_velocity[0].manual_speed == True:
                result = move(rtdl_config[2][0].scenario_modifier[0].sm_robot_velocity[0].robot_speed,
                              self.config.robot_cmd_vel, 
                              rtdl_config[2][0].scenario_modifier[0].sm_robot_velocity[0].speed_duration)
        except:
